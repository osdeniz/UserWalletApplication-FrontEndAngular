...
@NgModule({
  ...
  imports:[CommonModule,ReactiveFormsModule,WalletRoutingModule]//module oluitururken belli başlı modullere ihtiyaç var bu import edilen kütüphaneden genel modulleri çekebiliyoruz ng,ngfor,form elemanları gibi.
})
